"""Cameras_CSI2 module entry point using the stub (codex) stack.
...
if __package__ in {None, ""}:
    __package__ = "rpi_logger.modules.Cameras_CSI2"
...
DISPLAY_NAME = "Cameras-CSI2"
MODULE_ID = "cameras_csi2"

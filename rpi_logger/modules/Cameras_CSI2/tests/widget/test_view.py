"""Comprehensive tests for CSI2CameraView GUI wiring.

Tests ALL user interactions: menu clicks, settings changes, state rendering.
This is the point of the Elm/Redux refactor - full GUI testability.
"""
...
def view_with_dispatch(mock_stub_view, action_collector):
    ...
    view = CSI2CameraView(mock_stub_view)
    view.attach()

"""Preview pipeline consumer for USB cameras."""
...
from rpi_logger.modules.USBCameras.domain.frame import FramePayload, RollingFpsCounter
...
class PreviewConsumer:
    ...
    def _record_view_frame(self, slot: USBCameraSlot) -> None:

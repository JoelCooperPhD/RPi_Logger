"""
VOG USB device identification.

Matches USB devices by VID/PID to determine if they are VOG devices.
"""
...
def identify_vog_device(vid: int, pid: int) -> Optional[DeviceMatch]:
    """

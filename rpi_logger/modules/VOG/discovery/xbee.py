"""
VOG XBee node ID parsing.

Parses XBee node IDs to identify wireless VOG devices.
"""
...
def parse_vog_node_id(node_id: str) -> Optional[DeviceMatch]:
    """
    Parse XBee node ID for VOG devices.

    Expected formats:
    - "wVOG_XX" or "wVOG XX" where XX is a number

"""Registry state machine for Cameras."""
...
from rpi_logger.modules.Cameras.runtime import CameraDescriptor, CameraId, CameraRuntimeState, RuntimeStatus, SelectedConfigs

...
async def parse_json_body(request: web.Request, required: bool = True):
    """Parse JSON body from request, returning (body, error_response)."""
    try:
...
def setup_cameras_routes(app: web.Application, controller) -> None:
    """Register Cameras-specific routes."""

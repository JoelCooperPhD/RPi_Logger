"""Typed configuration helpers for Cameras2."""
...
DEFAULT_PREVIEW_RESOLUTION: Resolution = (640, 480)
DEFAULT_PREVIEW_FPS = 30.0
DEFAULT_PREVIEW_FORMAT = "RGB"
DEFAULT_PREVIEW_OVERLAY = True
DEFAULT_RECORD_RESOLUTION: Resolution = (1920, 1080)
...
DEFAULT_LOG_FILE = Path("./logs/cameras2.log")
...
def persist_config_sync(preferences: ModulePreferences, config: Cameras2Config) -> bool:
...
async def persist_config_async(preferences: ModulePreferences, config: Cameras2Config) -> bool:
...
def _flatten_config(config: Cameras2Config) -> Dict[str, Any]:
...
def as_dict(config: Cameras2Config) -> Dict[str, Any]:

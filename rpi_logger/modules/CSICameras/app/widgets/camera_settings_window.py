...
# Image adjustment controls (Card 2) - Picam controls
IMAGE_CONTROLS = [
    "Brightness",
    "Contrast",
    "Saturation",
...
# Exposure/Focus controls (Card 3) - Picam-specific controls
...
CONTROL_DEPENDENCIES = {
    ...
    # LensPosition only works in Manual focus mode
...
class CameraSettingsWindow:
    ...
    def update_camera_capabilities(
        ...
        *,
        ...
        # Format backend nicely: "picam" -> "Pi Camera"
        backend_display = backend or "Unknown"
        if backend_display.lower() == "picam":
    ...
    def _ensure_window(self) -> None:
        ...
        self._window.title("CSI Camera Settings")
    ...
    def _rebuild_controls_section(self) -> None:
        ...
        # Build image controls (Brightness, Contrast, Saturation, etc.)
        image_controls = []
        seen = set()
    ...
    def _update_title(self) -> None:
        ...
        try:
            self._window.title(f"CSI Camera Settings - {camera_label}")
        except Exception:

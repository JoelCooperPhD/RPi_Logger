"""CSICameras module entry point leveraging the stub (codex) stack."""
...
if __package__ in {None, ""}:
    __package__ = "rpi_logger.modules.CSICameras"
...
def parse_args(argv: Optional[list[str]] = None):
    ...
    # Build defaults from CSICamerasConfig
    defaults = {
        "output_dir": "csicameras",
    ...
    add_common_cli_arguments(
        ...
        include_auto_recording=False,  # CSICameras doesn't use auto-recording
...
async def main_async(argv: Optional[list[str]] = None) -> None:
    ...
    def show_csicameras_help(parent):
        from rpi_logger.modules.CSICameras.app.help_dialog import CSICamerasHelpDialog
        CSICamerasHelpDialog(parent)
    ...
    supervisor = StubCodexSupervisor(
        ...
        help_callback=show_csicameras_help,
    )

...
# ---------------------------------------------------------------------------
# Capture abstraction (from capture.py)
...
class CaptureHandle:
    ...
    Both USB and CSI camera implementations inherit from this class
    to provide a unified capture interface.
    """
    ...
    def actual_fps(self) -> float:
        """Return actual FPS after camera opened."""
        raise NotImplementedError
...
__all__ = [
    ...
    "serialize_control",
    "deserialize_control",
    "serialize_selected_configs",
    "deserialize_selected_configs",
    "serialize_mode_selection",
    "deserialize_mode_selection",
    # Schema version
    "SCHEMA_VERSION",
]

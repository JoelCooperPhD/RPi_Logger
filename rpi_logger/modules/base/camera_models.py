...
This module is shared by both USB and CSI camera modules.
"""
...
# Default file location - can be overridden per-module
DEFAULT_MODELS_PATH = Path(__file__).parent.parent / "Cameras" / "camera_models.json"

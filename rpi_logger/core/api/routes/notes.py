"""
Notes Module Routes - Notes-specific API endpoints.

Provides dedicated endpoints for the Notes module that go beyond
the generic module command interface.

Endpoints:
- GET  /api/v1/modules/notes/config       - Get notes configuration
- PUT  /api/v1/modules/notes/config       - Update notes configuration
- POST /api/v1/modules/notes              - Add a new note
- GET  /api/v1/modules/notes              - Get all notes for current session
- GET  /api/v1/modules/notes/{id}         - Get specific note
- DELETE /api/v1/modules/notes/{id}       - Delete a note
- GET  /api/v1/modules/notes/categories   - Get available note categories
- GET  /api/v1/modules/notes/status       - Get module status
"""
...
def setup_notes_routes(app: web.Application, controller: APIController) -> None:

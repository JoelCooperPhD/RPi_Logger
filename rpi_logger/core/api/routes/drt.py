"""
DRT Module Routes - DRT (Detection Response Task) specific API endpoints.

Endpoints:
- GET  /api/v1/modules/drt/devices     - List available DRT devices (sDRT/wDRT)
...
- GET  /api/v1/modules/drt/responses   - Get recent responses
- GET  /api/v1/modules/drt/statistics  - Get session statistics (avg RT, hits, misses)
- GET  /api/v1/modules/drt/battery     - Get battery level (wDRT only)
- GET  /api/v1/modules/drt/status      - Get module status
"""
...
def setup_drt_routes(app: web.Application, controller: APIController) -> None:

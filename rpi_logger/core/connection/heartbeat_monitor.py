...
class HeartbeatSender:
    """
    Helper class for modules to send heartbeats.

    Usage in module:
        sender = HeartbeatSender(interval=2.0)
        await sender.start()
        # ... module runs ...
        await sender.stop()
    """
    ...
    def __init__(
        self,
        interval: float = 2.0,
        send_func: Optional[Callable[[], None]] = None,
    ):
        """
        ...
        Args:
            ...
            send_func: Function to call to send heartbeat (default: StatusMessage.send)
        """
        self.interval = interval
    ...
    async def _heartbeat_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # Don't let heartbeat errors crash the module
                pass
    ...
    def _send_heartbeat(self) -> None:
        ...
        if self._send_func:
            ...
            # Default: use StatusMessage
            from rpi_logger.core.commands import StatusMessage
            uptime = time.time() - self._start_time
            StatusMessage.send("heartbeat", {"uptime": round(uptime, 1)})

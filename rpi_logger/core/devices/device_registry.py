...
NOTE: This file is being deprecated in favor of module-driven discovery.
The types (InterfaceType, DeviceFamily, DeviceType) have been moved to types.py.
This file still contains DeviceSpec, DEVICE_REGISTRY, and helper functions
...
# Import types from their new home
from .types import InterfaceType, DeviceFamily, DeviceType

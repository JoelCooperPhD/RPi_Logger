...
class TestNMEAParser:
    ...
    def test_fix_state_accumulation(self):
        ...
        # speed_kmh is calculated from speed_knots (5.5 * 1.852 = 10.186)
        assert parser.fix.speed_kmh == pytest.approx(5.5 * 1.852)
    ...
    def test_checksum_validation_enabled(self):
        ...
        # Valid checksum
        result = parser.parse_sentence("$GPGGA,123519,4807.038,N,01131.000,E,1,08,0.9,545.4,M,47.0,M,,*4F")
        assert result is not None
